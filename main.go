...
func registerModels() {
	...
	orm.RegisterModel(new(models.AgentObservation))
	orm.RegisterModel(new(models.AgentChangeEvent))
	orm.RegisterModel(new(models.AgentTradeProposal))
	orm.RegisterModel(new(models.AgentTradeExecution))
	orm.RegisterModel(new(models.AgentTradeAudit))
